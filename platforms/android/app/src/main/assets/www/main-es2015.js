...
const routes = [
    ...
    {
        path: 'modal-login',
        loadChildren: () => Promise.all(/*! import() | pages-modal-login-modal-login-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-modal-login-modal-login-module")]).then(__webpack_require__.bind(null, /*! ./pages/modal-login/modal-login.module */ "./src/app/pages/modal-login/modal-login.module.ts")).then(m => m.ModalLoginPageModule)
    },
    {
        path: 'modal-signup',
        loadChildren: () => Promise.all(/*! import() | pages-modal-signup-modal-signup-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-modal-signup-modal-signup-module")]).then(__webpack_require__.bind(null, /*! ./pages/modal-signup/modal-signup.module */ "./src/app/pages/modal-signup/modal-signup.module.ts")).then(m => m.ModalSignupPageModule)
    },
    {
        path: 'inicio',
...
/* harmony import */ var _ionic_native_firebase_authentication_ngx__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic-native/firebase-authentication/ngx */ "./node_modules/@ionic-native/firebase-authentication/__ivy_ngcc__/ngx/index.js");
...
/* harmony import */ var _ionic_native_firebase_authentication_ngx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic-native/firebase-authentication/ngx */ "./node_modules/@ionic-native/firebase-authentication/__ivy_ngcc__/ngx/index.js");
...
let UsuarioService = class UsuarioService {
    ...
    login(email, password) {
        ...
        return new Promise(resolve => {
            this.http.post(`${URL}/usuarios/login`, body, { headers })
                .subscribe(resp => {
                if (resp['token'] != null) {
    ...
    registro(usuario) {
        return new Promise(resolve => {
            this.http.post(`${URL}/usuarios/registro`, usuario)
                .subscribe(resp => {
                if (resp['token'] != null) {
                    this.guardarToken(resp['token']);
                    console.log(resp['token']);
...
module.exports = __webpack_require__(/*! /Users/jafetandresgalvezquezada/Dropbox/curso-ionic6/promoshop/promoshop/src/main.ts */"./src/main.ts");
