                ...
                while (1) {
                  switch (_context10.prev = _context10.next) {
                    ...
                    case 2:
                      ...
                      return _context10.abrupt("return", this.http.get("".concat(URL, "/listarubicaciones"), {
                        headers: headers
                      }));
                ...
                while (1) {
                  switch (_context11.prev = _context11.next) {
                    ...
                    case 2:
                      ...
                      return _context11.abrupt("return", this.http.get("".concat(URL, "/listartarjetas"), {
                        headers: headers
                      }));
                ...
                while (1) {
                  switch (_context12.prev = _context12.next) {
                    ...
                    case 2:
                      ...
                      return _context12.abrupt("return", this.http.post("".concat(URL, "/registrartarjeta"), tarjeta, {
                        headers: headers
                      }));
