...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'tab4',
                loadChildren: () => __webpack_require__.e(/*! import() | tab4-tab4-module */ "tab4-tab4-module").then(__webpack_require__.bind(null, /*! ../tab4/tab4.module */ "./src/app/pages/tab4/tab4.module.ts")).then(m => m.Tab4PageModule)
            },
            {
                path: '',
