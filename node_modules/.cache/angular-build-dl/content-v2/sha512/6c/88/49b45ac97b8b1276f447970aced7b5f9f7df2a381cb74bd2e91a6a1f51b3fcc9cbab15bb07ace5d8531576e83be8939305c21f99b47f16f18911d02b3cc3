(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-inicio-inicio-module"], {
    ...
    function srcAppPagesInicioInicioPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _modal_login_modal_login_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../modal-login/modal-login.page */
      "./src/app/pages/modal-login/modal-login.page.ts");
      /* harmony import */


      var _modal_signup_modal_signup_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
